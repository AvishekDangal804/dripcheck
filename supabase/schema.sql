...
create index idx_fit_checks_created_at on fit_checks (created_at desc);
create index idx_fit_checks_user_id on fit_checks (user_id);
create index idx_fit_checks_public on fit_checks (is_public) where is_public = true;
...
create index idx_outfits_score on outfits (score desc);
...
create index idx_likes_outfit_id on likes (outfit_id);
